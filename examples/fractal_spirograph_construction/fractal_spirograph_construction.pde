...
//constants
final static int CIRCLE_PATH = 0, SQUARE_PATH = 1, INFINITY_PATH = 2, LISSAJOUS_PATH = 3, ROSE_PATH = 4, POLYGON_PATH = 5;
...
int polyOrder = 5; //used for polygon paths
...
void setup() {
  ...
  //stringToSketch("5 0.25 180.0 1.0E-4 -4 -3657166 3 3 4 1.0471976 4");
  initComponentPaths();
